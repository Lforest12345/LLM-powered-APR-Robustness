...
- Configuration Variables
  ...
  The corresponding file is `validate_Defects4J.sh`. Before running the script, please modify the following variables according to your requirements:
